...
const languages = [
  { code: "uz", label: "O'zbek", flag: "fi-uz" },
...
const notifications = [
  {
    id: 1,
    title: "Yangi xabar",
    description: "Sizga yangi xabar keldi",
    time: "5 daqiqa oldin",
  },
  {
    id: 2,
    title: "Hujjat tasdiqlandi",
    description: "Sizning hujjatingiz tasdiqlandi",
    time: "1 soat oldin",
  },
  {
    id: 3,
    title: "Meeting eslatmasi",
    description: "15:00 da meeting boshlanadi",
    time: "2 soat oldin",
  },
];
...
export const Navbar = ({ onToggleSidebar, isSidebarOpen }: NavbarProps) => {
  ...
  className="relative w-9 h-9 rounded-full bg-secondary flex items-center justify-center overflow-hidden"
>
  <Sun
  ...
  />
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" size="sm" className="gap-2 rounded-full">
              <span className={`fi ${selectedLang.flag} w-5 h-4 rounded-sm`} />
          ...
          <DropdownMenuContent
            align="end"
            className="bg-popover border border-border z-[100]"
          >
            {languages.map((lang) => (
              <DropdownMenuItem
                key={lang.code}
                ...
                className={`flex items-center gap-2 cursor-pointer ${
                  language === lang.code ? "bg-[#ECDAFD] text-[#7302d5]" : ""
                }`}
              >
                <span className={`fi ${lang.flag} w-5 h-4 rounded-sm`} />
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-80 bg-popover border border-border z-[100]"
          >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
              className="w-9 h-9 rounded-full flex items-center justify-center text-white font-semibold text-sm overflow-hidden"
              style={{
          ...
          <DropdownMenuContent
            align="end"
            className="w-56 bg-card border border-border dark:border-white/20 z-[100] shadow-lg rounded-xl p-1"
          >
            ...
            <DropdownMenuItem className="flex items-center gap-3 px-3 py-2.5 cursor-pointer rounded-lg hover:bg-destructive/10 text-destructive transition-colors">
